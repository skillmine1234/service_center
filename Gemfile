...
gem 'qg-sc',:path=>'/Users/rubyistdhruv/Mahesh/qg-sc'#'4.1.0',:git => "https://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:x-oauth-basic@github.com/Capgemini008/qg-sc.git", branch: 'esbconfig_without_approval'
...
gem 'qg-cc','2.6.0',:git => "https://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:x-oauth-basic@github.com/Capgemini008/qg-cc.git",branch: 'master'
