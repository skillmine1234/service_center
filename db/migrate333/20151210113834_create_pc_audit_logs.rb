class CreatePcAuditLogs < ActiveRecord::Migration[7.0]
  def change
    create_table :pc_audit_logs do |t|#, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
      ...
      t.index([:app_id, :req_no, :attempt_no], :unique => true, :name => 'uk_pc_audit_logs_1')
      t.index([:pc_auditable_type, :pc_auditable_id], :unique => true, :name => 'uk_pc_audit_logs_2')
    end
  end
end
