class CreateSmAuditSteps < ActiveRecord::Migration[7.0]
  def change
    create_table :sm_audit_steps do |t|#, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
      ...
      t.index([:sm_auditable_type, :sm_auditable_id, :step_no, :attempt_no], :unique => true, :name => "uk_sm_audit_steps")
    end
  end
end
