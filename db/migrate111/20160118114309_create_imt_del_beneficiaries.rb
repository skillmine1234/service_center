class CreateImtDelBeneficiaries < ActiveRecord::Migration[7.0]
  def change
    create_table :imt_del_beneficiaries do |t|#, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
      ...
      t.index([:req_no, :app_id, :attempt_no], :unique => true, :name => 'uk_imt_del_bene')
    end
  end
end
