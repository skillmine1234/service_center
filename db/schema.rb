...
ActiveRecord::Schema.define(version: 20160528041012) do
  ...
  create_table "incoming_files", id: false, force: :cascade do |t|
  ...
  add_index "incoming_files", ["pending_approval"], name: "i_inc_fil_pen_app"
  add_index "incoming_files", ["service_name"], name: "i_incoming_files_service_name"
  add_index "incoming_files", ["status"], name: "index_incoming_files_on_status"
  ...
  create_table "salary_payments", force: :cascade do |t|
    ...
    t.string   "bank_reference_no",     limit: 40
    t.string   "debit_reference_no",    limit: 40
    t.integer  "payment_attempt_no",               precision: 38
