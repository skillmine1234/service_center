...
ActiveRecord::Schema.define(version: 20150528035640) do
  ...
  create_table "inward_remittances", force: :cascade do |t|
    ...
    t.string   "rmtr_first_name",     limit: 255
    t.string   "rmtr_last_name",      limit: 255
    ...
    t.string   "bene_first_name",     limit: 255
    t.string   "bene_last_name",      limit: 255
