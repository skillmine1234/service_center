...
ActiveRecord::Schema.define(version: 20160629145029) do
  ...
  create_table "bm_gt_all_accounts", temporary: true, id: false, force: :cascade do |t|
    t.string "biller_code"
    t.string "biller_account_id"
    t.string "biller_short_name"
    t.string "status"
  ...
  create_table "imt_transfers", force: :cascade do |t|
    ...
    t.decimal  "transfer_amount",                  null: false
    t.string   "initiation_ref_no",     limit: 64
  ...
  create_table "mstbeneficiary", id: false, force: :cascade do |t|
    t.string   "bene_id",            limit: 30,                                           null: false
    t.string   "user_id",            limit: 20,                                           null: false
    t.string   "cust_id",            limit: 30,                                           null: false
    t.boolean  "txn_type",           limit: nil,                          default: false, null: false
    t.string   "bene_name",          limit: 100
    t.string   "sortcode",           limit: 25
    t.string   "bene_acctno",        limit: 40
    t.string   "nam_ccy_short",      limit: 3
    t.string   "bene_country",       limit: 35
    t.string   "nam_bank",           limit: 100
    t.string   "nam_brn",            limit: 100
    t.string   "id_creator",         limit: 20
    t.string   "swift_code",         limit: 11
    t.datetime "dat_creation"
    t.raw      "msg",                limit: nil
    t.string   "bene_desc"
    t.string   "cust_group",         limit: 1,                            default: "1"
    t.decimal  "txn_limit",                      precision: 22, scale: 3
    t.boolean  "status",             limit: nil
    t.string   "email"
    t.decimal  "daily_limit",                    precision: 22, scale: 3
    t.string   "eftbankid",          limit: 9
    t.string   "eftcityid",          limit: 9
    t.string   "eftbranchid",        limit: 9
    t.string   "destaccttype",       limit: 3
    t.string   "bene_add1",          limit: 35
    t.string   "bene_add2",          limit: 35
    t.string   "bene_add3",          limit: 35
    t.string   "bene_city",          limit: 35
    t.string   "bene_pin",           limit: 6
    t.string   "bene_phone",         limit: 12
    t.datetime "expirydat"
    t.string   "modificationreason", limit: 60
    t.string   "beneficiary_mmid",   limit: 7
  end
