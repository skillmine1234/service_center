class CreateFtCustAccounts < ActiveRecord::Migration[7.0]
  def change
    create_table :ft_cust_accounts do |t|#, {:sequence_start_value => '1 cache 20 order increment by 1'}  do |t|
    ...
    add_index :ft_cust_accounts, [:customer_id, :account_no, :approval_status], :unique => true, :name => "ft_cust_accounts_01"
  end
end
