class CreateQgEcolTodaysNeftTxns < ActiveRecord::Migration[7.0]
  def up
    unless Rails.env == 'production'
      def self.connection
       QgEcolTodaysNeftTxn.connection
      end
      create_table :qg_ecol_todays_neft_txns do |t|#, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
