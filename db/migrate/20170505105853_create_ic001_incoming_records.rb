class CreateIc001IncomingRecords < ActiveRecord::Migration
  def change
    create_table :ic001_incoming_records, {:sequence_start_value => '1 cache 20 order increment by 1'}  do |t|
      ...
      t.index([:incoming_file_record_id,:file_name], :unique => true, :name => 'ic001_incoming_records_01')                   
    end
  end
end
