class CreateSmPendingConfirmations < ActiveRecord::Migration
  def change
    create_table :sm_pending_confirmations, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
      ...
      t.index([:sm_auditable_type, :sm_auditable_id], :unique => true, :name => 'sm_confirmations_01')
      t.index([:broker_uuid], :name => 'sm_confirmations_02')
    end
  end
end
