class CreateFtIncomingRecords < ActiveRecord::Migration
  def change
    create_table :ft_incoming_records, {:sequence_start_value => '1 cache 20 order increment by 1'}  do |t|
           ...
           t.number  :transfer_amount, :comment => "the amount which has to be transferred to the beneficiary"
           ...
           t.integer  :attempt_no, :comment => " the attempt no of the request"         
           ...
           t.string  :fault_reason, :limit => 1000, :comment => "the reason for the failure"                               
