class CreateInwAuditSteps < ActiveRecord::Migration
  def change
    create_table :inw_audit_steps, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
      ...
      t.integer :inw_auditable_id, :null => false, :comment => "the id of the row that represents the request that is related to this recrod"
      ...
      t.index([:inw_auditable_type, :inw_auditable_id, :step_no, :attempt_no], :unique => true, :name => "uk_inw_audit_steps")
    end
  end
end
