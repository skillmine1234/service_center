class CreateBmPayBills < ActiveRecord::Migration
  def change
    create_table :bm_pay_bills, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
      ...
      t.string :bill_id, :limit => 50, :null => false, :comment => 'the unique identifier of the bill, as received in getBill operation'
