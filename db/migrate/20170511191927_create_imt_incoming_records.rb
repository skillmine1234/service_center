class CreateImtIncomingRecords < ActiveRecord::Migration[7.0]
  def change
    create_table :imt_incoming_records do |t|#, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
