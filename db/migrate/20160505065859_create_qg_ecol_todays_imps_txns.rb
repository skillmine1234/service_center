  ...
  def up
    unless Rails.env == 'production'
      ...
      create_table :qg_ecol_todays_imps_txns, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
        ...
        t.string :transfer_type, :limit => 4, :null => false, :comment => "the type of the transfer i.e., IMPS"
        t.string :transfer_status, :limit => 25, :comment => "the status of the transfer"
        t.string :transfer_unique_no, :limit => 64, :null => false, :comment => "the RRN of incoming ecollect payment"
        ...
        t.string :error_code, :limit => 4, :comment => "the error code of the atom"
      end
