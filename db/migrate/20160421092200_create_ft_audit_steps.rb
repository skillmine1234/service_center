class CreateFtAuditSteps < ActiveRecord::Migration[7.0]
  def change
    create_table :ft_audit_steps do |t|#:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
      ...
      t.integer :ft_auditable_id, :null => false, :comment => "the id of the row that represents the request that is related to this recrod"
      ...
      t.index([:ft_auditable_type, :ft_auditable_id, :step_no, :attempt_no], :unique => true, :name => "uk_ft_audit_steps")
    end
  end
end
