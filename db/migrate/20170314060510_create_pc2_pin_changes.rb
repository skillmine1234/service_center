class CreatePc2PinChanges < ActiveRecord::Migration
  def change
    create_table :pc2_pin_changes, {:sequence_start_value => '1 cache 20 order increment by 1'}  do |t|
      ...
      t.string :old_pin, :limit => 10, :comment => "the old pin number for the card"
      t.string :new_pin, :limit => 10, :comment => "the new pin number for the card"
      ...
      t.index([:req_no, :app_id, :attempt_no], :unique => true, :name => 'uk_pc2_pin_changes')
    end
  end
end
