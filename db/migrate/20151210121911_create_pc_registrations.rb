class CreatePcRegistrations < ActiveRecord::Migration
  def change
    create_table :pc_registrations do |t|
      ...
      t.datetime :birth_date, :comment => "the birth date of the customer"
      ...
      t.integer :pc_customer_id, :limit => 255, :comment => "the id of the row that represents the request that is related to this recrod"
