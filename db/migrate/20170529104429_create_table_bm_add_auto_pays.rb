class CreateTableBmAddAutoPays < ActiveRecord::Migration
  def change
    create_table :bm_add_auto_pays, {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
     ...
     t.string :credit_card_no, :limit => 20, :comment => "the credit card number which will be using to pay bill"
     ...
     t.string :mobile_no, :limit => 20, :comment => "the registered mobile number of the customer"
