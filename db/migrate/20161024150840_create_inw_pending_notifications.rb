class CreateInwPendingNotifications < ActiveRecord::Migration
  def change
    create_table :inw_pending_notifications , {:sequence_start_value => '1 cache 20 order increment by 1'} do |t|
