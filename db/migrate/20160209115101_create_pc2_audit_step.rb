class CreatePc2AuditStep < ActiveRecord::Migration
  def change
    create_table :pc2_audit_steps do |t|
      t.string :pc2_auditable_type, :null => false, :comment => "the name of the table that represents the request that is related to this record"
      ...
      t.index([:pc2_auditable_type, :pc2_auditable_id, :step_no, :attempt_no], :unique => true, :name => "uk_pc2_audit_steps")
    end
  end
end
