...
describe Partner do
  ...
  context "should_allow_neft? and should_allow_imps?" do
    ...
    it "should raise error when the mobile no. and email are not present in the customer setup in FCR" do
      ...
      partner = Factory.build(:partner, code: '2345', allow_neft: 'Y', allow_imps: 'N', account_no: '1234567890')
      partner.errors_on(:base).should == ["Customer details not found in FCR for 2345"]
    end
  ...
  context "should_allow_imps?" do
    ...
    it "should raise error when mobile_no is not 2222222222 in ATOM for the customer setup" do
      fcr_customer = Factory(:fcr_customer, cod_cust_id: '2345', ref_phone_mobile: '9999999999', ref_cust_email: nil)
      atom_customer = Factory(:atom_customer, customerid: '2345', mobile: '9999999999', isactive: '1', accountno: '1234567890')
      partner = Factory.build(:partner, code: '2345', allow_neft: 'N', allow_imps: 'Y', account_no: '1234567890')
      partner.errors_on(:base).should == ["Customer details not found in ATOM for 1234567890"]
    end
    ...
    it "should raise error when there is no corresponding record in ATOM" do
      ...
      partner.errors_on(:code).should == ["no record found in ATOM for 234"]
    ...
    it "should raise error when the mobile no.s in FCR and ATOM do not match for the customer" do
      ...
      partner = Factory.build(:partner, code: '2345', allow_neft: 'N', allow_imps: 'Y', account_no: '1234567890')
      partner.errors_on(:base).should == ["Mobile no.s in ATOM and FCR setup do not match for 2345"]
    end
  end
