...
describe OutgoingFilesHelper do
  ...
  context "find_outgoing_files" do 
    it "should return outgoing files" do
      ...
      outgoing_file = Factory(:outgoing_file, :service_code => '1234')
      find_outgoing_files({:service_code => "1234"}).should == [outgoing_file]
      find_outgoing_files({:service_code => "CUST01"}).should == [] 
