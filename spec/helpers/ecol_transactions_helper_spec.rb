...
describe EcolTransactionsHelper do
  ...
  context "ecol_transaction_token_show" do
    it "should return token types from customer" do
      ecol_customer = Factory(:ecol_customer, :code => '9876', :token_1_type => 'SC', :token_1_length => 1)
      ...
      ecol_customer = Factory(:ecol_customer, :code => '9111', :token_1_type => 'RC', :token_1_length => 1)
      ecol_transaction_token_show(ecol_transaction,1).should == ecol_transaction.remitter_code
      ecol_customer = Factory(:ecol_customer, :code => '9000', :token_1_type => 'IN', :token_1_length => 1)
      ecol_transaction_token_show(ecol_transaction,2).should == ecol_transaction.invoice_no
      ecol_customer = Factory(:ecol_customer, :code => '9222', :token_1_type => 'N', :token_1_length => 0)
