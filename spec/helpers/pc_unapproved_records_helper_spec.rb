...
describe PcUnapprovedRecordsHelper do
  context "filter_records" do 
    it "should return records" do
      ...
      filter_records(PcUnapprovedRecord).should eq([{:record_type=>"PcApp", :record_count=>1}, {:record_type=>"PcFeeRule", :record_count=>0}, {:record_type=>"PcProgram", :record_count=>1}, {:record_type=>"IncomingFile", :record_count=>0}])
    end
  end
end
