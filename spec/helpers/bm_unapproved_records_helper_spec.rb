...
describe BmUnapprovedRecordsHelper do
  context "filter_records" do 
    it "should return records" do
      ...
      filter_records(EcolUnapprovedRecord).should eq([{:record_type=>"BmRule", :record_count=>1}, {:record_type=>"BmBiller", :record_count=>0}, {:record_type=>"BmAggregatorPayment", :record_count=>0}])
    end
  end
end
