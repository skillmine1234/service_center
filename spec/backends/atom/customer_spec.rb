...
describe Atom::Customer do
  ...
  context "imps_allowed_for_accounts" do
    it "should return true if imps is allowed for all accounts" do
      ...
      atom_customer1 = Factory(:atom_customer, customerid: '2345', mobile: '2222222222', isactive: '1', accountno: '1234511111')
      atom_customer2 = Factory(:atom_customer, customerid: '2345', mobile: '2222222222', isactive: '1', accountno: '1234522222')
    ...
    it "should return error hash if imps is not allowed for all accounts" do
      ...
      fcr_cust_acct2 = Factory(:fcr_cust_acct, cod_cust: '2345', cod_acct_cust_rel: 'GUR', cod_acct_no: '1234522222')
      atom_customer1 = Factory(:atom_customer, customerid: '2345', mobile: '2222222222', isactive: '1', accountno: '1234511111')
      atom_customer2 = Factory(:atom_customer, customerid: '2345', mobile: '9999990000', isactive: '1', accountno: '1234522222')
