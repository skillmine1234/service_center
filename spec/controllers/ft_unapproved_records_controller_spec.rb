...
describe FtUnapprovedRecordsController do
  ...
  describe "GET index" do
    it "assigns all ft_unapproved_records as @ft_unapproved_records" do
      ...
      get :index
      assigns(:records).should eq([{:record_type=>"FundsTransferCustomer", :record_count=>1}, {:record_type=>"FtPurposeCode", :record_count=>0}, {:record_type=>"IncomingFile", :record_count=>0}])
    end
  end
end
