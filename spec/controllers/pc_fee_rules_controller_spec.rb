...
describe PcFeeRulesController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pc_fee_rule" do
        ...
        params[:tier1_from_amt] = 1000
        put :update, {:id => pc_fee_rule.id, :pc_fee_rule => params}
        pc_fee_rule.reload
        pc_fee_rule.tier1_from_amt.should == 1000
      end
  ...
  describe "PUT approve" do
    it "(edit) unapproved record can be approved and old approved record will be updated" do
      ...
      pc_fee_rule2 = Factory(:pc_fee_rule, :approval_status => 'U', :tier1_from_amt => 10000, :approved_version => pc_fee_rule1.lock_version, :approved_id => pc_fee_rule1.id, :created_by => 666)
      ...
      pc_fee_rule1.reload
      pc_fee_rule1.tier1_from_amt.should == 10000
    ...
    it "(create) unapproved record can be approved" do
      ...
      user_role.delete
      Factory(:user_role, :user_id => @user.id, :role_id => Factory(:role, :name => 'supervisor').id)
      pc_fee_rule = Factory(:pc_fee_rule, :approval_status => 'U', :tier1_from_amt => 10000)
      PcUnapprovedRecord.count.should == 1
      put :approve, {:id => pc_fee_rule.id}
      PcUnapprovedRecord.count.should == 0
      pc_fee_rule.reload
      pc_fee_rule.tier1_from_amt.should == 10000
