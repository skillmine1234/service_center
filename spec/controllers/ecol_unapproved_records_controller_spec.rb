...
describe EcolUnapprovedRecordsController do
  ...
  describe "GET index" do
    it "assigns all ecol_unapproved_records as @ecol_unapproved_records" do
      ...
      get :index
      assigns(:records).should eq([{:record_type=>"EcolCustomer", :record_count=>0}, {:record_type=>"EcolRemitter", :record_count=>0}, {:record_type=>"UdfAttribute", :record_count=>0}, {:record_type=>"EcolRule", :record_count=>1}])
    end
  end
end
