class EcolRemitter < ActiveRecord::Base
  ...
  validates :remitter_code, presence: true, format: {with: /\A[a-z|A-Z|0-9]+\z/, :message => 'Invalid format, expected format is : {[a-z|A-Z|0-9]}' }, length: {maximum: 15, minimum: 1}
  ...
  validate :validate_customer_subcode_details, :customer_code_should_exist
