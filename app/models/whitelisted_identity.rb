  ...
  def validate_whitelisted_identity
    unless partner.nil?
      ...
      unless inw_txn.nil?
        ...
        errors.add(:full_name, "the transaction does not have any remitter code, choose a different transaction to whitelist this remitter ") if partner.will_send_id == 'N' and inw_txn.rmtr_code.nil? and id_for == 'R'
      end
