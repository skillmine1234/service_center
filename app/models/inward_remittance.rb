class InwardRemittance < ActiveRecord::Base
  ...
  has_many :remitter_identities,  :conditions => { id_for: 'R'}, :class_name => 'InwIdentity', :foreign_key => 'inw_remittance_id'
  has_many :beneficiary_identities,  :conditions => { id_for: 'B'}, :class_name => 'InwIdentity', :foreign_key => 'inw_remittance_id'
