class Group < ActiveRecord::Base
  ...
  def model_list
    ...
    when "e-collect"
      ['EcolUnapprovedRecord','EcolRule','EcolCustomer','EcolRemitter','EcolTransaction','UdfAttribute','IncomingFile','EcolFetchStatistic','QgEcolTodaysNeftTxn','QgEcolTodaysRtgsTxn','QgEcolTodaysImpsTxn']
    ...
    when "funds-transfer"
      ['FundsTransferCustomer','FtUnapprovedRecord', 'ReconciledReturn', 'FtPurposeCode','FtIncomingRecord','IncomingFile','IncomingFileRecord','FtIncomingFile']
    when "salary-upload"
