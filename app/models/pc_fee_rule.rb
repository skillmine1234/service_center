class PcFeeRule < ActiveRecord::Base
  ...
  validates :tier1_from_amt, :tier1_to_amt, :tier1_fixed_amt, :tier1_min_sc_amt, :tier1_max_sc_amt, :tier2_from_amt, :tier2_to_amt, :tier2_fixed_amt, :tier2_min_sc_amt, :tier2_max_sc_amt, :tier3_from_amt, :tier3_to_amt, :tier3_fixed_amt, :tier3_min_sc_amt, :tier3_max_sc_amt, :numericality => {:greater_than_or_equal_to => 0, :less_than_or_equal_to => 9999999999}, :allow_blank => true
