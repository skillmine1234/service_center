class PcApp < ActiveRecord::Base
  ...
  validates_presence_of :app_id, :card_acct, :sc_gl_income, :card_cust_id, :traceid_prefix, :source_id, :channel_id, :mm_host, :mm_consumer_key, :mm_consumer_secret, :mm_card_type, :mm_email_domain
