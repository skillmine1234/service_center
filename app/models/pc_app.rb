class PcApp < ActiveRecord::Base
  ...
  belongs_to :pc_program, :class_name => 'PcProgram'
  
  validates_presence_of :app_id, :pc_program_id, :card_acct, :sc_gl_income, :card_cust_id, :traceid_prefix, :source_id, :channel_id, :identity_user_id
