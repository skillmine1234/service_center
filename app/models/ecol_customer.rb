class EcolCustomer < ActiveRecord::Base
  ...
  validates :rmtr_pass_txt, format: {with: /\A[a-z|A-Z|0-9]{1,500}+\z/}, :allow_blank => true
  validates :rmtr_return_txt, format: {with: /\A[a-z|A-Z|0-9]{1,500}+\z/}, :allow_blank => true
