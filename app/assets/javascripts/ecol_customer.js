$(document).ready(function(){
  ...
  $("#ecol_customer_token_1_type").on("change",function(){
    ...
    if (token_1_type == 'N'){
      ...
      $('#ecol_customer_token_1_length').prop('disabled',true);
    }
    else{
      $('#ecol_customer_val_token_1').prop('disabled',false);
      $('#ecol_customer_token_1_length').prop('disabled',false);
    }
  });
  ...
  $("#ecol_customer_token_2_type").on("change",function(){
    ...
    if (token_2_type == 'N'){
      ...
      $('#ecol_customer_token_2_length').prop('disabled',true); 
    }
    else{
      $('#ecol_customer_val_token_2').prop('disabled',false);
      $('#ecol_customer_token_2_length').prop('disabled',false);
    }
  });
  ...
  $("#ecol_customer_token_3_type").on("change",function(){
    ...
    if (token_3_type == 'N'){
      ...
      $('#ecol_customer_token_3_length').prop('disabled',true); 
    }
    else{
      $('#ecol_customer_val_token_3').prop('disabled',false);
      $('#ecol_customer_token_3_length').prop('disabled',false);
    }
  });
